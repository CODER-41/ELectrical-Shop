        ...
        <footer className="bg-gradient-to-br from-orange-500 via-orange-600 to-yellow-600 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    {/*Quick Links*/}
                    <div>
                        <h4 className="text-sm font-semibold mb-4 uppercase text-orange-300 flex items-center">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/products" className='text-gray-300 hover:text-orange-300 text-sm transition-colors duration-200 flex items-center group'>
                            ...
                            <li>
                                <Link to="/about" className='text-gray-300 hover:text-orange-300 text-sm transition-colors duration-200 flex items-center group'>
                                    <svg className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                    About Us 
                            ...
                            <li>
                                <Link to="/contact" className="text-gray-300 hover:text-orange-300 text-sm transition-colors duration-200 flex items-center group">
                                    <svg className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                    Contact Us
                    ...
                    {/*Customer Service*/}
                    <div>
                        <h4 className="text-sm font-semibold mb-4 uppercase text-yellow-300 flex items-center">
                            <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/faq" className="text-gray-300 hover:text-yellow-300 text-sm transition-colors duration-200 flex items-center group">
                                    <svg className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                    FAQs
                            ...
                            <li>
                                <Link to="/returns" className="text-gray-300 hover:text-yellow-300 text-sm transition-colors duration-200 flex items-center group">
                                    <svg className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                    Returns Policy 
                            ...
                            <li>
                                <Link to="/warranty" className="text-gray-300 hover:text-yellow-300 text-sm transition-colors duration-200 flex items-center group">
                                    <svg className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                    Warranty Info
                    ...
                    {/*Legal*/}
                    <div>
                        <h4 className="text-sm font-semibold mb-4 uppercase text-orange-400 flex items-center">
                            <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/terms" className="text-gray-300 hover:text-orange-400 text-sm transition-colors duration-200 flex items-center group">
                                    <svg className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                    Terms & Conditions
                            ...
                            <li>
                                <Link to="/privacy" className="text-gray-300 hover:text-orange-400 text-sm transition-colors duration-200 flex items-center group">
                                    <svg className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                    Privacy Policy
                ...
                <div className='border-t border-gray-700 mt-8 pt-6'>
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex items-center space-x-4 mt-4 md:mt-0">
                            ...
                            <span className="text-gray-400 text-xs">in Kenya</span>
                        </div>
                    </div>
                </div>
            </div>
