...
const Home = () => {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-orange-500 via-orange-600 to-yellow-500 overflow-hidden">
      ...
      {/* Features Section */}
      <div className="py-16 bg-gradient-to-br from-orange-50 via-yellow-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-full mx-auto flex items-center justify-center mb-6">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Feature 3 */}
            <div className="bg-white shadow-xl rounded-2xl p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              <div className="w-16 h-16 bg-gradient-to-r from-orange-600 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-6 justify-items-center">
            {[
              { name: 'Mobile Phones', displayName: 'Mobile Phones', image: mobileImg, slug: 'mobile-phones-tablets', color: 'from-orange-500 to-orange-600' },
              { name: 'Laptops', displayName: 'Laptops', image: laptopsImg, slug: 'laptops-computers', color: 'from-yellow-500 to-yellow-600' },
              { name: 'TVs', displayName: 'TVs', image: tvsImg, slug: 'tvs-home-entertainment', color: 'from-orange-600 to-yellow-500' },
              { name: 'Kitchen', displayName: 'Kitchen', image: kitchenImg, slug: 'kitchen-appliances', color: 'from-yellow-600 to-orange-500' },
              { name: 'Gaming', displayName: 'Gaming', image: gamingImg, slug: 'gaming', color: 'from-orange-400 to-yellow-400' },
              { name: 'Accessories', displayName: 'Accessories', image: accessoriesImg, slug: 'accessories', color: 'from-yellow-500 to-orange-600' }
            ].map((category) => (
              <Link
                key={category.name}
      ...
      {/* CTA Section */}
      {!isAuthenticated && (
        <div className="bg-gradient-to-r from-orange-500 to-yellow-500 relative overflow-hidden">
          <div className="absolute inset-0 bg-black opacity-10"></div>
