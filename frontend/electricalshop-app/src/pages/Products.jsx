      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-gradient-to-r from-orange-600 to-yellow-600 rounded-full mx-auto flex items-center justify-center mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <form onSubmit={handleSearch} className="flex-1">
                <div className="relative">
                  ...
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-orange-600 to-yellow-600 text-white px-4 py-1.5 rounded-lg hover:from-orange-700 hover:to-yellow-700 transition-all text-sm font-medium"
                  >
                    Search
                  </button>
                </div>
